    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='user provided name', max_length=32)),
                ('email', models.CharField(help_text='user provided email', max_length=32)),
            ],
        ),
        ...
        migrations.AddField(
            model_name='errorreport',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='services.UserDetails'),
        ),
    ]
