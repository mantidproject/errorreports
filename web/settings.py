...
SLACK_ERROR_REPORTS_CHANNEL = os.getenv("SLACK_ERROR_REPORTS_CHANNEL", "#error-reports")
SLACK_SERVER_ERRORS_CHANNEL = os.getenv(
    "SLACK_SERVER_ERRORS_CHANNEL", "#linode-app-errors"
)
SLACK_ERROR_REPORTS_USERNAME = os.getenv(
